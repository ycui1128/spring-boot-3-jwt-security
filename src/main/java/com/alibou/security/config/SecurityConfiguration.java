...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .requestMatchers(GET, "/api/v1/management/**").hasAnyAuthority(ADMIN_READ.name(), MANAGER_READ.name()) // 代表admin和manager都有权限访问management路径
        ...
        .anyRequest()    //这行代码指定了除了之前配置的路径以外的所有请求都需要进行身份验证
          .authenticated()
        .and()
          .sessionManagement()
